      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Card 1 */}
            <div className="bg-white/70 backdrop-blur-lg rounded-2xl shadow-lg p-8 flex flex-col items-center hover:scale-105 hover:shadow-2xl transition-all duration-300 border border-blue-100 group">
              <div className="flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-tr from-blue-500 to-blue-300 text-white text-4xl mb-4 shadow-lg group-hover:scale-110 transition-transform duration-200">
                <FaBullseye />
              </div>
              <h4 className="font-bold text-lg text-gray-900 mb-2 group-hover:text-blue-700 transition-colors duration-200">
                Student Empowerment
              </h4>
              <p className="text-gray-600 text-base text-center">
                Continuing to bridge the gap between academia and industry
              </p>
            </div>
            {/* Card 2 */}
            <div className="bg-white/70 backdrop-blur-lg rounded-2xl shadow-lg p-8 flex flex-col items-center hover:scale-105 hover:shadow-2xl transition-all duration-300 border border-indigo-100 group">
              <div className="flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-tr from-indigo-500 to-indigo-300 text-white text-4xl mb-4 shadow-lg group-hover:scale-110 transition-transform duration-200">
                <FaRocket />
              </div>
              <h4 className="font-bold text-lg text-gray-900 mb-2 group-hover:text-indigo-700 transition-colors duration-200">
            ...
            {/* Card 3 */}
            <div className="bg-white/70 backdrop-blur-lg rounded-2xl shadow-lg p-8 flex flex-col items-center hover:scale-105 hover:shadow-2xl transition-all duration-300 border border-green-100 group">
              <div className="flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-tr from-green-500 to-green-300 text-white text-4xl mb-4 shadow-lg group-hover:scale-110 transition-transform duration-200">
                <FaHandshake />
              </div>
              <h4 className="font-bold text-lg text-gray-900 mb-2 group-hover:text-green-700 transition-colors duration-200">
                Client Success
              </h4>
              <p className="text-gray-600 text-base text-center">
                Building lasting partnerships and delivering exceptional results
              </p>
            </div>
          </div>
        </motion.div>
